  <div class="page-content row">
    ...
    <div class="toolbar-line ">		
		...
		<a href="<?php echo site_url('groups/add') ?>" class="tips btn btn-xs btn-info"  title="New">
		...
		<a href="<?php echo site_url('groups/download') ?>" class="tips btn btn-xs btn-default" title="Download">
		<i class="fa fa-download"></i><?php echo $this->lang->line('core.btn_download'); ?> </a>
		<?php endif;
		if($this->session->userdata('gid') ==1) : ?>	
		<a href="<?php echo site_url('sximo/module/config/groups') ?>" class="tips btn btn-xs btn-default"  title="Configuration">
