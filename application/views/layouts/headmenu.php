	 ...
	 <ul class="nav navbar-top-links navbar-right">
		...
		<li class="user dropdown">
			...
			<ul class="dropdown-menu dropdown-menu-right icons-right">
				...
				<li><a href="<?php echo site_url('blogadmin') ;?>"><i class="fa fa-folder-open"></i> Blog Posts </a></li>
				...
				<li><a href="<?php echo site_url('sximo/config/getHelp'); ?>"><i class="fa fa-book"></i> Manual Guide</a></li>	
			</ul>
		</li>	
