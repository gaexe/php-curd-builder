         ...
         <div class="page-content-wrapper m-t">
            ...
            <div class="row">
              ...
              <div class="col-md-8 doc-content" style="margin-bottom:50px;">
                  ...
                  <h2 id="create-module">Create new module </h2>
                    ...
                    <img src="<?php echo base_url('uploads/documents/create_module.png') ?>" style="width:100%" class="img img-responsive"/><br>
                    <img src="<?php echo base_url('uploads/documents/create_module2.png') ?>" style="width:100%" class="img img-responsive"/><br>
                  ...
                  <h2 id="edit-module"> Edit Modules   </h2>
                    ...
                    <img src="<?php echo base_url('uploads/documents/edit_mod.png') ?>" style="width:100%" class="img img-responsive"/>
                    ...
                    <img src="<?php echo base_url('uploads/documents/edit_mod2.png') ?>" style="width:100%" class="img img-responsive"/>
                    <p class="separator"> </p>
                ...
                <table  class="table table-bordered table-striped">
                  ...
                  <p><img src="<?php echo base_url('uploads/documents/mysql_editor.png') ?>" style="width:100%" class="img img-responsive"/></p>
                ...
                <h2 id="edit-table">  Module Table </h2>
                  <p><img src="<?php echo base_url('uploads/documents/grid_table.png') ?>" style="width:100%" /></p>
                  ...
                  <p><img src="<?php echo base_url('uploads/documents/table_grid_editor.png') ?>" style="width:100%" class="img img-responsive"/></p>
                  <h4> Displaying row as image</h4>
                  ...
                  <p><img src="<?php echo base_url('uploads/documents/display_image.png') ?>" style="width:100%" class="img img-responsive"/></p>
                  ...
                  <p><img src="<?php echo base_url('uploads/documents/looked_up.png') ?>" style="width:100%" class="img img-responsive"/></p>  
                  <p><img src="<?php echo base_url('uploads/documents/looked_up1.png') ?>" style="width:100%" class="img img-responsive"/></p>  

                  <p class="doc-line"> </p>  

                <h2 id="edit-form">  Module Form </h2>
                <p> At this moment , system only able to work with , Hidden Form , Text Form , Date Form , Date Time , Select , Checkbox , Radio  </p>
              ...
              <div class="tab-content ">
                ...
                <div id="select" class="tab-pane use-padding ">
                  ...
                  <img src="<?php echo base_url('uploads/documents/select.png') ?>" style="width:100%" class="img img-responsive"/>
              ...
              <h2 id="edit-permission">  Module Permission </h2>
                ...
                <img src="<?php echo base_url('uploads/documents/permission_mod.png') ?>" style="width:100%" class="img img-responsive"/>
          ...
          We try to cover this possibility by adding rebuild modules features  </p>
                <img src="<?php echo base_url('uploads/documents/rebuild.png') ?>" style="width:100%" class="img img-responsive"/>
                <img src="<?php echo base_url('uploads/documents/rebuild1.png') ?>" style="width:100%" class="img img-responsive"/>
