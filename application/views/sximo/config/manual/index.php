   ...
   <div class="page-content-wrapper">
      <div class="row">
          ...
          <div class="col-md-8" style = "margin-bottom:50px;">
                ...
                <img src="<?php echo base_url('uploads/documents/setting_up.png') ?>" style="width:100%" />
              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="table table-bordered">
                  ...
                  <tr>
                    <td>Muliti language <br />Only Layout Interface </td>
               ...
               <div class="doc-line"><hr></div>
                <h4 > Email Template </h4>
                <img src="<?php echo base_url('uploads/documents/email_template.png') ?>" style="width:100%" />
                ...
                <h4 >Login Via Social Networking  </h4>
                <img src="<?php echo base_url('uploads/documents/socmed.png') ?>" style="width:100%" />
              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="table table-bordered">
                  <tr>
                    <th scope="col">Parameter</th>
                    <th scope="col">Description</th>
                ...
                <img src="<?php echo base_url('uploads/documents/security.png') ?>" style="width:100%" class="img img-responsive"/>
