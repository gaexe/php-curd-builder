 	...
 	<div class="page-content-wrapper m-t">
		...
		<div class="block-content">
			<ul class="nav nav-tabs" >
				...
				<li class="active"><a href="<?php echo site_url('sximo/config/security');?>"><?php echo $this->lang->line('core.tab_loginsecurity'); ?> </a></li>
				<li ><a href="<?php echo site_url('sximo/config/getTranslation');?>" >Translation <sup>New </sup></a></li>
			</ul>
