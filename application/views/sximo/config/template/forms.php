...
<div class="page-header"> <!-- Page header -->
  ...
  <div class="page-content-wrapper m-t">
    <?php $this->load->view('sximo/config/template/tab',array('active'=>$page)); ?>
	   <div class="row">
        <div class="col-md-6">
        <div class="header"><h3>Basic Form</h3></div>
        <div class="content">
            <form role="form"> 
      ...
      <div class="col-md-6">
        <div class="header"><h3>Horizontal Form</h3></div>
        <div class="content">
     ...
     <div class="row">
        <div class="col-md-6">
        <div class="header"><h3>Basic Elements</h3></div>
        <div class="content">
      ...
      <div class="col-md-6">
        <div class="header"><h3>Select & Option Elements</h3></div>
        <div class="content">
            <form style="border-radius: 0px;" action="#" class="form-horizontal group-border-dashed">
              <div class="form-group">
     ...
     <div class="row">
        <div class="col-md-12">
        <div class="header"><h3 class="text-center">Input Groups</h3></div>
        <div class="content">
            <form style="border-radius: 0px;" action="#" class="form-horizontal group-border-dashed">
              <div class="form-group">
                <label class="col-sm-3 control-label">Input Text</label>
