      ...
      <?php foreach ( $rowData as $i => $row ) : ?>
         ...
         <td>
           <div class="btn-group">    
            ...
            <li><a href="<?php echo site_url('{class}/show/'.$row->{key})?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
            <?php endif;
            if($access['is_edit'] ==1) : ?>
            <li><a  href="<?php echo site_url('{class}/add/'.$row->{key})?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
            <?php endif;?>
