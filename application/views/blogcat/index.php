  ...
  <div class="page-content-wrapper m-t">
    ...
    <a href="<?php echo site_url('blogcat/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
    ...
    <a href="<?php echo site_url('blogcat/download') ?>" class="tips btn btn-xs btn-default" title="<?php echo $this->lang->line('core.btn_download'); ?>">
    <i class="fa fa-download"></i>&nbsp;<?php echo $this->lang->line('core.btn_download'); ?></a>
    <?php endif;
    if($this->session->userdata('gid') ==1) : ?>  
    <a href="<?php echo site_url('sximo/module/config/blogcat') ?>" class="tips btn btn-xs btn-default"  title="<?php echo $this->lang->line('core.btn_config'); ?>">
  ...
  <form action='<?php echo site_url('blogcat/destroy') ?>' class='form-horizontal' id ='SximoTable' method="post" >
   <div class="table-responsive">
    <table class="table table-striped ">
      ...
      <?php foreach ( $rowData as $i => $row ) : ?>
          ...
          <td width="50"><input type="checkbox" class="ids" name="id[]" value="<?php echo $row->CatID ?>" />  </td>
         ...
         <td>
           <div class="btn-group">    
            ...
            <li><a href="<?php echo site_url('blogcat/show/'.$row->CatID)?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
            <?php endif;
            if($access['is_edit'] ==1) : ?>
            <li><a  href="<?php echo site_url('blogcat/add/'.$row->CatID)?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
            <?php endif;?>
...
$(document).ready(function(){
  ...
  $('.do-quick-search').click(function(){
    $('#SximoTable').attr('action','<?php echo site_url("blogcat/multisearch");?>');
    $('#SximoTable').submit();
  });
